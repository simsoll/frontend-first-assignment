...
![The color scheme showing the primary and complementary colors.\label{color-scheme}](./handover/images/color-scheme.jpg)
...
![Text elements showing the chosen primary typeface \label{text-elements}](./handover/images/typeface.jpg)

![Head line showing the chosen primary typeface in combination with secondary typeface  \label{head-line}](./handover/images/head-line.jpg)
...
![Default button states. From top to button; default, hover, active and disabled.\label{button-states}](./handover/images/button-states.jpg)
...
![Small width navigation bar\label{navigation-small-width}](./handover/images/navigation-small-width.jpg)

![Medium width navigation bar\label{navigation-medium-width}](./handover/images/navigation-medium-width.jpg)
...
### Navigation
![Gestalt sketch of the navigation bar\label{gestalt-navigation}](./handover/images/navigation.jpg)
...
### Front page 
![Gestalt sketch of the front page \label{gestalt-front-page}](./handover/images/front-page.jpg)
...
### Product page
![Gestalt sketch of the product page\label{gestalt-product-page}](./handover/images/product-page.jpg)
...
### Purchase page
![Gestalt sketch of the product page\label{gestalt-purchase-page}](./handover/images/purchase-page.jpg)
